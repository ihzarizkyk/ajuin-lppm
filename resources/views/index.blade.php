        ...
        <div class="container-fluid shadow py-5" data-bs-spy="scroll" class="scrollspy-example">
          ...
          <div class="container">
            <div class="owl-carousel owl-theme">
              ...
              <div class="item"><img src="assets_ajuin/Mapúa_University_logo.png" width="120" alt=""class="m-5"></div>
              ...
              <div class="item"><img src="{{ asset('ajuin/assets_ajuin/Mapúa_University_logo.png') }}" width="120" alt=""class="m-5"></div>
