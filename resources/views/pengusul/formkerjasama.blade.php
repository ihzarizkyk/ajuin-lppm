...
<div class="section-header">
  <h1>Ajukan Usulan Kerjasama</h1>
  <div class="section-header-breadcrumb">
    <div class="breadcrumb-item"><a href="#">Dashboard</a></div>
    <div class="breadcrumb-item active"><a href="#">Ajukan Usulan</a></div>
  </div>
</div>
@endsection
@section('isi')
...
<div class="container-fluid">
    <div class="card mt-3">
        ...
        <h4 style="color:white">Form Ajukan Kerjasama Baru</h4>
        </div>

        <div class="card body">

        <form enctype="multipart/form-data" class="mt-4 col-xl-8 offset-2" method="POST" action="{{ url('daftar/kerjasama') }}" class="needs-validation" novalidate="">
            @csrf
                <div class="row col-8">
                @if(count($errors) > 0)
            ...
            <a href="#" class="btn btn-danger btn-lg btn-icon icon-right float-right mb-3 mr-2 mt-3" tabindex="3">
                  Kerjasama
            </a>
...
<!--             <div class="form-group">
            ...
            <div class="form-group mr-3 mb-3">
                ...
                <textarea id="perihal_kerjasama" value="{{ old('perihal_kerjasama') }}" type="text" class="form-control" name="perihal_kerjasama" tabindex="1" required autofocus></textarea>
                <div class="invalid-feedback">
                    Harus diisi
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <input id="unit_pelaksana" value="{{Auth::user()->unit}}" type="text" class="form-control" name="unit_pelaksana" tabindex="1" required autofocus></input>
                <div class="invalid-feedback">
                    Harus diisi
                </div>
            </div>
            <div class="form-group">
                ...
                <textarea id="deskripsi" value="{{ old('deskripsi') }}" type="text" class="form-control" name="deskripsi" tabindex="1" required autofocus></textarea>
                <div class="invalid-feedback">
                    Harus diisi
                </div>
            ...
            <div class="form-group">
                ...
                <textarea id="rencana_implementasi" value="{{ old('rencana_implementasi') }}" type="text" class="form-control" name="rencana_implementasi" tabindex="1" required autofocus></textarea>
                <div class="invalid-feedback">
                    Harus diisi
                </div>
                <div id="passwordHelpBlock" class="form-text">
